...
const handleProfileClick = () => {
  if (currentUser) {
    if (userRole === "recruiter") {
      navigate("/employer-dash/company-profile");
    } else if (userRole === "admin") {
      ...
      <footer className=" md:block  right-0 z-10 bg-gray-900 text-white pt-12 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 pb-12 border-b border-gray-700">
            ...
            <div className='' >
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li className="flex items-center gap-2">
                  <FaMapMarkerAlt /> 120 Mahamai Ka Bagh Jagriti Colony Pushpa Nagar Chouraha Bhopal
                </li>
                <li className="flex items-center gap-2">
                  <FaEnvelope /> ashu.enterprises2@gmail.com
                </li>
                <li className="flex items-center gap-2">
                  <FaPhoneAlt /> 9111461666
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-300">
                <li><a href="all-job" className="hover:text-white">All Jobs</a></li>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center py-6 text-sm text-gray-400">
            <p>© 2025 Kammilgya.com — Devloped by <a href="https://www.skyinfogroup.com/"> Skyinfo Group</a>.</p>
