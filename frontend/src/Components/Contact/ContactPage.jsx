...
import  {createContact}   from "../../app//Contact/contactThunk"
...
const ContactPage = () => {
 ...
 const handleSubmit = async (e) => {
  ...
  e.preventDefault();
  try {
    await dispatch(createContact(formData)).unwrap(); // thunk se action call
      ...
      <div className="max-w-7xl mx-auto bg-white rounded-3xl shadow-xl overflow-hidden">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-gray-800">Address</h4>
                  <p className="text-gray-600">
                   120 Mahamai Ka Bagh Jagriti Colony Pushpa Nagar Chouraha Bhopal
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-gray-800">Phone</h4>
                  <p className="text-gray-600">9111461666</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-gray-800">Email</h4>
                  <p className="text-gray-600">ashu.enterprises2@gmail.com</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-8">
          <iframe
            ...
            loading="lazy"
            allowFullScreen
            src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d3832356.071937338!2d74.49811292971441!3d20.27810151506574!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1s120%20Mahamai%20Ka%20Bagh%2C%20Jagriti%20Colony%2C%20Pushpa%20Nagar%20Chouraha%2C%20Bhopal!5e0!3m2!1sen!2sin!4v1754138581716!5m2!1sen!2sin"
          ></iframe>
        </div>
      </div>
    </div>
